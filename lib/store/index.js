...
function incrementKey(key) {
    var decoded = exports.base64ToBytes(key);
...
exports.setp = setp;
function nullifyAll(obj, descriptor) {
...
exports.SelectionFlags$$MASK_FORCE_OR_UPDATE = 4 /* FORCE */ | 3 /* CLICKED_UPDATE */;
exports.PojoState$$MASK_STATUS = 1 /* SUCCESS */ | 2 /* ERROR */ | 4 /* WARNING */;
exports.PojoListState$$MASK_SELECTED_REFRESH = 2 /* SELECTED */ | 4 /* REFRESH */;
exports.PagerState$$MASK_STATUS = 1 /* SUCCESS */ | 2 /* ERROR */ | 4 /* WARNING */;
exports.PagerState$$MASK_RPC = 32 /* LOAD_NEWER */ | 64 /* LOAD_OLDER */ | 128 /* RELOAD */;
exports.PagerState$$MASK_RPC_DISABLE = 8 /* LOADING */ | 256 /* LOCAL_SEARCH */;
...
var PojoStore = (function () {
    ...
    PojoStore.prototype.$select = function (current, flags, idx, page, selectWithoutPopulate) {
        ...
        if (prevKey) {
            ...
            else if ((state & exports.PojoState$$MASK_STATUS)) {
                previous_[c.MSG] = null;
            }
            if (same)
    ...
    PojoStore.prototype.getStartObj = function () {
        var pager = this.pager, masked = exports.PagerState$$MASK_RPC & pager.state;
        switch (masked) {
            case 32 /* LOAD_NEWER */:
                return this.get(0);
            case 64 /* LOAD_OLDER */:
    ...
    PojoStore.prototype.callbackFromFetch = function (array) {
        var pager = this.pager, masked = exports.PagerState$$MASK_RPC & pager.state;
        $bit_unset(pager, c.STATE, exports.PagerState$$MASK_RPC);
        switch (masked) {
            case 32 /* LOAD_NEWER */:
                this.addAll(array, true, false);
                break;
