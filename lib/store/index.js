...
var PojoStore = (function () {
    ...
    PojoStore.prototype.newRangeKeyForLoadNewer = function () {
        ...
        var first = this.get(0), limit = 0 !== (16 /* DESC */ & pager.state) ? toPopulate.length : toPopulate.length * this.multiplier;
        this.startObj = first;
        return ds.ParamRangeKey.$create(false, limit, first[this.k]);
    };
    PojoStore.prototype.newRangeKeyForLoadOlder = function () {
        var pager = this.pager, toPopulate = pager.array, last = this.get(this.size() - 1), limit = 0 !== (16 /* DESC */ & pager.state) ? toPopulate.length * this.multiplier : toPopulate.length;
        this.startObj = last;
