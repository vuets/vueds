...
export function nullifyAll(obj) {
    for (var i in obj) {
        if (obj[i] !== null)
            obj[i] = null;
    }
...
(function (c) {
    ...
    c.VFBS = "vfbs"; // validation field bit set
    c.VPROPS = "vprops";
    c.DESCRIPTOR = "$d";
    c.INDEX = "$index";
    c.PREV_KEY = "$prev_key";
...
function createVprops(descriptor) {
...
function createObservable(options, index, pager, descriptor, vprops) {
    var so = {
        state: 0,
        lstate: 0,
        msg: '',
...
export var PojoStore = (function () {
    function PojoStore(fetchedArray, options) {
        ...
        var vprops = createVprops(descriptor);
    ...
    PojoStore.prototype.$newRangeKeyForReload = function (desc) {
        ...
        key = first['key'] || first[options.keyProperty], kh = options.kh;
    ...
    PojoStore.prototype.requestNewer = function () {
        var pager = this.pager;
        $bit_clear_and_set(pager, c.STATE, 7 /* MASK_STATUS */, 8 /* LOADING */ | 32 /* LOAD_NEWER */);
        this.options.fetch(this.newRangeKeyForLoadNewer(), pager);
    };
    PojoStore.prototype.requestOlder = function () {
        var pager = this.pager;
        $bit_clear_and_set(pager, c.STATE, 7 /* MASK_STATUS */, 8 /* LOADING */ | 64 /* LOAD_OLDER */);
        this.options.fetch(this.newRangeKeyForLoadOlder(), pager);
    };
    PojoStore.prototype.reload = function () {
        var pager = this.pager;
        $bit_clear_and_set(pager, c.STATE, 7 /* MASK_STATUS */, 8 /* LOADING */ | 128 /* RELOAD */);
    ...
    PojoStore.prototype.cbFetchSuccess = function (array) {
        var pager = this.pager, masked = 224 /* MASK_RPC */ & pager.state;
        $bit_unset(pager, c.STATE, 224 /* MASK_RPC */ | 8 /* LOADING */);
        switch (masked) {
            case 32 /* LOAD_NEWER */:
                this.addAll(array, true, false);
                break;
    ...
    PojoStore.prototype.cbFetchFailed = function (err) {
        var pager = this.pager;
        $bit_clear_and_set(pager, c.STATE, 224 /* MASK_RPC */ | 8 /* LOADING */, 2 /* ERROR */);
