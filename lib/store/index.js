import { ds } from '../ds/';
import { mergeVmFrom, defp, extractMsg, mergeFrom } from '../';
...
var PojoStore = (function () {
    ...
    PojoStore.prototype.update = function (updateArray) {
        var options = this.options, descriptor = options.descriptor, fnMergeFrom = this.fnMergeFrom, main = this.isMainArray(), pager = this.pager, toPopulate = pager.array, desc = !!(pager.state & 16 /* DESC */), page = pager.page, size = this.size();
        var removedArray;
