...
function validateString(val, message, fd, fk, f, flag, message_, dfbs, prop, el, update, root) {
    var msg = null, dirty = !!val, v;
    if (dirty) {
        // backup data
...
function validateFloat(val, message, fd, fk, f, flag, message_, dfbs, prop, el, update, root) {
    var msg = null, dirty = !!val, v;
    if (dirty) {
        // backup data
        if (update && (v = message[prop]) !== undefined && v !== message_[prop])
...
function validateInt(val, message, fd, fk, f, flag, message_, dfbs, prop, el, update, root) {
    var msg = null, dirty = !!val, v;
    if (dirty) {
        // backup data
        if (update && (v = message[prop]) !== undefined && v !== message_[prop])
...
function validateTime(val, message, fd, fk, f, flag, message_, dfbs, prop, el, update, root) {
    var msg = null, dirty = !!val, v;
    if (dirty) {
        // backup data
        if (update && (v = message[prop]) !== undefined && v !== message_[prop])
...
function validateDate(val, message, fd, fk, f, flag, message_, dfbs, prop, el, update, root) {
    var msg = null, dirty = !!val, v;
    if (dirty) {
        // backup data
        if (update && (v = message[prop]) !== undefined && v !== message_[prop])
...
function validateDateTime(val, message, fd, fk, f, flag, message_, dfbs, prop, el, update, root) {
    var msg = null, dirty = !!val, v;
    if (dirty) {
        // backup data
        if (update && (v = message[prop]) !== undefined && v !== message_[prop])
